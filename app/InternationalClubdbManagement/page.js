...
import "./InternationalClubdbManagement.css";
...
export default function InternationalClubDatabaseManagement() {
    ...
    const handleDownloadExcel = () => {
        ...
        try {
            ...
            const tableName = selectedTable.replace('int_club_', '').toUpperCase();
            const fileName = `INTL_CLUB_${tableName}_${timestamp}.xlsx`;
            ...
            <div id="db-management-page" className={`egypt-container egyptclub-db-page ${isSidebarCollapsed ? 'sidebar-collapsed' : ''}`}>
                ...
                <div className="egypt-main-content">
                    ...
                    <main className="db-content">
                        {loading ? (
                            <Loading_db title="INTERNATIONAL CLUBS" subtitle="DATABASE" message="SYNCING WITH DATABASE..." inline={true} />
                        ) : (
                            <>
                                <DatabaseToolbar 
