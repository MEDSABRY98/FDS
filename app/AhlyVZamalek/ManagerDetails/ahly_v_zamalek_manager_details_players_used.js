...
export default function ManagerPlayersUsed({ stats }) {
    ...
    const SortIndicator = ({ columnKey }) => {
        ...
        return <span style={{ marginLeft: '5px', color: 'var(--mgr-gold)' }}>{sortConfig.direction === 'asc' ? '↑' : '↓'}</span>;
    };
                        ...
                        <tbody>
                            {playersList.map((p, idx) => (
                                <tr key={p.name}>
                                    ...
                                    <td style={{ textAlign: 'center', fontFamily: 'Outfit', fontWeight: '900', fontSize: '22px', color: 'var(--mgr-gold)' }}>
                                        {p.apps || "-"}
                                    </td>
                                    ...
                                    <td style={{ textAlign: 'center', color: 'var(--mgr-gold)', fontWeight: '900', fontSize: '22px', fontFamily: 'Outfit' }}>
                                        {p.goals || "-"}
                                    </td>
                            ...
                            <tr style={{ background: 'rgba(201, 168, 76, 0.05)', borderTop: '2px solid var(--mgr-gold)' }}>
                                ...
                                <td style={{ fontWeight: '900', color: 'var(--mgr-gold)', textTransform: 'uppercase', letterSpacing: '2px', fontSize: '14px', fontFamily: 'Outfit' }}>
                                    TOTAL
                                </td>
                                ...
                                <td style={{ textAlign: 'center', color: 'var(--mgr-gold)', fontWeight: '900', fontSize: '26px', fontFamily: 'Outfit' }}>
                                    {totals.goals || "-"}
                                </td>
