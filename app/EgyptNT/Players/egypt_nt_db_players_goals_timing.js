export default function EgyptNTPlayersGoalsTiming({ paginatedRows, currentPage, pageSize, handleSort, renderSortIcon, setSelectedPlayer }) {
    return (
