export default function AlAhlyPlayersAssistsTiming({ paginatedRows, currentPage, pageSize, handleSort, renderSortIcon, setSelectedPlayer }) {
    return (
        <table className="modern-player-table fade-in" style={{ tableLayout: 'fixed' }}>
            ...
            <thead>
                <tr>
                    ...
                    <th rowSpan="2" style={{ background: '#2980b9', color: '#fff' }} onClick={() => handleSort('total')} className="sortable"> TOTAL {renderSortIcon('total')} </th>
