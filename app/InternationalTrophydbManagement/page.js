...
import "./InternationalTrophydbManagement.css";
...
export default function InternationalTrophyDatabaseManagement() {
    ...
    const handleDownloadExcel = () => {
        ...
        try {
            ...
            const tableName = selectedTable.replace('int_TROPHY_', '').replace('int_', '').toUpperCase();
            const fileName = `INTL_TROPHY_${tableName}_${timestamp}.xlsx`;
            ...
            <div id="db-management-page" className={`egypt-container egyptclub-db-page ${isSidebarCollapsed ? 'sidebar-collapsed' : ''}`}>
                ...
                <div className="egypt-main-content">
                    ...
                    <main className="db-content">
                        {loading ? (
                            <Loading_db title="INTL TROPHY" subtitle="DATABASE" message="SYNCING WITH DATABASE..." inline={true} />
                        ) : (
                            <>
                                <DatabaseToolbar 
